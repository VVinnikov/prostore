            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(1))
                        .isEqualToIgnoringNewLines("CREATE WRITABLE EXTERNAL TABLE datamart1.TARANTOOL_EXT_matview\n" +
                                "(" +
                                "sys_op bigint,sys_to bigint,sys_from bigint,sys_op bigint,sys_to bigint,sys_from bigint," +
                                "col_varchar varchar,col_char varchar,col_bigint bigint,col_int bigint,col_int32 integer," +
                                "col_double double,col_float real,col_date bigint,col_time bigint,col_timestamp bigint," +
                                "col_boolean boolean,col_uuid varchar,col_link varchar,sys_op bigint,bucket_id bigint" +
                                ") " +
                                "LOCATION ('pxf://env__datamart1__matview_staging?PROFILE=tarantool-upsert&TARANTOOL_SERVER=tarantool:1234&USER=user&PASSWORD=pass&TIMEOUT_CONNECT=3001&TIMEOUT_READ=3002&TIMEOUT_REQUEST=3003')\n" +
