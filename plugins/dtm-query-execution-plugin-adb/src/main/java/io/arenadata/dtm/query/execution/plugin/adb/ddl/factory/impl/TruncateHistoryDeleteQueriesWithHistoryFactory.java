...
public class TruncateHistoryDeleteQueriesWithHistoryFactory implements TruncateHistoryDeleteQueriesFactory {
    ...
    public TruncateHistoryDeleteQueriesWithHistoryFactory(@Qualifier("adbSqlDialect") SqlDialect sqlDialect) {
