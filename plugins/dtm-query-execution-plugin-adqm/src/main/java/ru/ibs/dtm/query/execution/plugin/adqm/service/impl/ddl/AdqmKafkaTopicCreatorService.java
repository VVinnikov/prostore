...
@Slf4j
@Service
public class AdqmKafkaTopicCreatorService implements KafkaTopicCreatorService {

    private KafkaAdminClient adminClient;

    @Autowired
    public AdqmKafkaTopicCreatorService(@Qualifier("adqmKafkaAdminClient") KafkaAdminClient adminClient) {
