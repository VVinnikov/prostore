...
public class MpprKafkaRequestFactoryImpl implements MpprKafkaRequestFactory {
  ...
  @Override
  public MpprKafkaRequest create(QueryRequest queryRequest, QueryExloadParam queryExloadParam, JsonObject schema) {
    val request = new MpprKafkaRequest(queryRequest, queryExloadParam, schema);
