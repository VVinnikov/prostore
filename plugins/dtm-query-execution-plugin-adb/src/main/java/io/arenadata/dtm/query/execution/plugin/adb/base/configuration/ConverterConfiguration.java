...
public class ConverterConfiguration {
    ...
    public Map<ColumnType, Map<Class<?>, ColumnTransformer>> transformerMap(DtmConfig dtmSettings) {
        ...
        AdbLongFromNumericTransformer adbLongFromNumericTransformer = new AdbLongFromNumericTransformer();
        transformerMap.put(ColumnType.INT, getTransformerMap(adbLongFromNumericTransformer));
        transformerMap.put(ColumnType.INT32, getTransformerMap(adbLongFromNumericTransformer));
