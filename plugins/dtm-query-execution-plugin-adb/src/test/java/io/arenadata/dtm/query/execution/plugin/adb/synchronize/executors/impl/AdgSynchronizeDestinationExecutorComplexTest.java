        ...
        result.onComplete(ar -> {
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT id, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE COALESCE(sys_to, 9223372036854775807) >= 0 AND (COALESCE(sys_to, 9223372036854775807) <= 0 AND sys_op = 1)");
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(1))
                        .isEqualToIgnoringNewLines("CREATE WRITABLE EXTERNAL TABLE datamart1.TARANTOOL_EXT_matview\n" +
                                ...
                                "FORMAT 'CUSTOM' (FORMATTER = 'pxfwritable_export')");
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 0 AND COALESCE(sys_to, 9223372036854775807) >= 0 GROUP BY id EXCEPT SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 1 AND COALESCE(sys_to, 9223372036854775807) >= 1 GROUP BY id");
                assertThat(allInvocations.get(3))
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(1))
                        .isEqualToIgnoringNewLines("CREATE WRITABLE EXTERNAL TABLE datamart1.TARANTOOL_EXT_matview\n" +
                                ...
                                "FORMAT 'CUSTOM' (FORMATTER = 'pxfwritable_export')");
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 0 AND COALESCE(sys_to, 9223372036854775807) >= 0 EXCEPT SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 1 AND COALESCE(sys_to, 9223372036854775807) >= 1");
                assertThat(allInvocations.get(3))
