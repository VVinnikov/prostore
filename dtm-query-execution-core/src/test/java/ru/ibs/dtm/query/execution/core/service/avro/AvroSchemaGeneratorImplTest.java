...
class AvroSchemaGeneratorImplTest {
    ...
    private List<ClassField> createFields() {
        ...
        return new ArrayList<>(Arrays.asList(f1, f2, f3, f4, f5, f6, f7));
    }

    @Test
    void generateSchemaFields() {
        String avroResult = "{\"type\":\"record\",\"name\":\"uplexttab\",\"namespace\":\"test_datamart\",\"fields\":" +
                "[{\"name\":\"id\",\"type\":[\"null\",\"int\"],\"default\":null,\"defaultValue\":\"null\"}," +
                "{\"name\":\"name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]," +
                "\"default\":null,\"defaultValue\":\"null\"},{\"name\":\"booleanvalue\",\"type\":[\"null\"," +
                "\"boolean\"],\"default\":null,\"defaultValue\":\"null\"},{\"name\":\"charvalue\",\"type\":" +
                "[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null,\"defaultValue\":\"null\"}" +
                ...
                "{\"name\":\"sys_op\",\"type\":[\"null\",\"int\"],\"default\":null,\"defaultValue\":\"null\"}]}";
