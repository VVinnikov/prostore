        ...
        result.onComplete(ar -> {
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT id, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE COALESCE(sys_to, 9223372036854775807) >= -1 AND (COALESCE(sys_to, 9223372036854775807) <= 1 AND sys_op = 1)");
                assertThat(allInvocations.get(3))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview SELECT id, col_varchar, col_char, col_bigint, col_int, col_int32, col_double, col_float, (col_date - DATE '1970-01-01') AS EXPR$8, EXTRACT(EPOCH FROM col_time) * 1000000 AS EXPR$9, EXTRACT(EPOCH FROM col_timestamp) * 1000000 AS EXPR$10, col_boolean, col_uuid, col_link, 0 AS EXPR$14 FROM datamart1.tbl1_actual WHERE sys_from >= 0 AND sys_from <= 2");
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(1))
                        .isEqualToIgnoringNewLines("CREATE WRITABLE EXTERNAL TABLE datamart1.TARANTOOL_EXT_matview\n" +
                                ...
                                "FORMAT 'CUSTOM' (FORMATTER = 'pxfwritable_export')");
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= -1 AND COALESCE(sys_to, 9223372036854775807) >= -1 GROUP BY id EXCEPT SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 2 AND COALESCE(sys_to, 9223372036854775807) >= 2 GROUP BY id");
                assertThat(allInvocations.get(3))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview SELECT 1 AS EXPR$0, SUM(id) AS EXPR$1, 0 AS EXPR$2 FROM datamart1.tbl1_actual WHERE sys_from <= 2 AND COALESCE(sys_to, 9223372036854775807) >= 2 GROUP BY id EXCEPT SELECT 1 AS EXPR$0, SUM(id) AS EXPR$1, 0 AS EXPR$2 FROM datamart1.tbl1_actual WHERE sys_from <= -1 AND COALESCE(sys_to, 9223372036854775807) >= -1 GROUP BY id");
                assertThat(allInvocations.get(4))
                        .isEqualToIgnoringNewLines("DROP EXTERNAL TABLE IF EXISTS datamart1.TARANTOOL_EXT_matview");
                verifyNoMoreInteractions(databaseExecutor);
                assertEquals(DELTA_NUM, ar.result());
            ...
            testContext.verify(() -> {
                ...
                assertThat(allInvocations.get(1))
                        .isEqualToIgnoringNewLines("CREATE WRITABLE EXTERNAL TABLE datamart1.TARANTOOL_EXT_matview\n" +
                                ...
                                "FORMAT 'CUSTOM' (FORMATTER = 'pxfwritable_export')");
                assertThat(allInvocations.get(2))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview (id, sys_op) SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= -1 AND COALESCE(sys_to, 9223372036854775807) >= -1 EXCEPT SELECT 1 AS EXPR$0, 1 AS EXPR$1 FROM datamart1.tbl1_actual WHERE sys_from <= 2 AND COALESCE(sys_to, 9223372036854775807) >= 2");
                assertThat(allInvocations.get(3))
                        .isEqualToIgnoringNewLines("INSERT INTO datamart1.TARANTOOL_EXT_matview SELECT 1 AS EXPR$0, COUNT(*) AS t, 0 AS EXPR$2 FROM datamart1.tbl1_actual WHERE sys_from <= 2 AND COALESCE(sys_to, 9223372036854775807) >= 2 EXCEPT SELECT 1 AS EXPR$0, COUNT(*) AS t, 0 AS EXPR$2 FROM datamart1.tbl1_actual WHERE sys_from <= -1 AND COALESCE(sys_to, 9223372036854775807) >= -1");
                assertThat(allInvocations.get(4))
                        .isEqualToIgnoringNewLines("DROP EXTERNAL TABLE IF EXISTS datamart1.TARANTOOL_EXT_matview");
                verifyNoMoreInteractions(databaseExecutor);
                assertEquals(DELTA_NUM, ar.result());
