...
class AdqmRollbackRequestFactoryTest {
    private static final List<String> EXPECTED_SQLS = Arrays.asList(
        "DROP TABLE dtm.tbl1_ext_shard ON CLUSTER cluster_1",
        "DROP TABLE dtm.tbl1_buffer_loader_shard ON CLUSTER cluster_1",
        "DROP TABLE dtm.tbl1_buffer ON CLUSTER cluster_1",
        "DROP TABLE dtm.tbl1_buffer_shard ON CLUSTER cluster_1",
        "SYSTEM FLUSH DISTRIBUTED dtm.tbl1_actual",
        "INSERT INTO dtm.tbl1_actual\n" +
            "  SELECT f1,f2,f3, sys_from, sys_to, sys_op, close_date, -1 AS sign\n" +
            "  FROM dtm.tbl1_actual\n" +
        ...
        "SYSTEM FLUSH DISTRIBUTED dtm.tbl1_actual",
        "OPTIMIZE TABLE dtm.tbl1_actual_shard ON CLUSTER cluster_1 FINAL"
    );
