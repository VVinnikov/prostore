...
@Service
@Slf4j
public class AdbCalciteDMLQueryParserServiceImpl implements QueryParserService {
  private Vertx vertx;

  @Autowired
  public AdbCalciteDMLQueryParserServiceImpl(@Qualifier("adbVertx") Vertx vertx) {
    this.vertx = vertx;
  }
