...
public class DockerImagesUtil {
    ...
    public static final String DTM_KAFKA_EMULATOR_READER = "ci.arenadata.io/connector-kafka-emulator-reader:loadtest";
    public static final String DTM_KAFKA_EMULATOR_WRITER = "ci.arenadata.io/db-writer:loadtest";
    ...
    public static final String DTM_CORE = "ci.arenadata.io/dtm-core:loadtest";
