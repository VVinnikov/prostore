...
import io.arenadata.dtm.query.execution.core.base.service.schema.LogicalSchemaService;
import io.arenadata.dtm.query.execution.core.base.service.schema.impl.LogicalSchemaServiceImpl;
...
class LogicalSchemaServiceImplTest {
    ...
    private final DeltaInformationExtractor deltaInformationExtractor = new DeltaInformationExtractorImpl(new CoreDtmSettings(ZoneId.of("UTC")));
