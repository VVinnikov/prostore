...
class UploadKafkaExecutorTest {
    ...
    private final Integer inpuStreamTimeoutMs = 250;
    private final Integer pluginStatusCheckPeriodMs = 250;
    private final Integer firstOffsetTimeoutMs = 1000;
    private final Integer changeOffsetTimeoutMs = 500;
